...
export default function Vehicle({className=""}: SectionProps) {
  return (
    <section id="vehicle" style={{ width: "100%", overflow: "hidden" }}>
              ...
              <div className={styles.cardVehicle} data-scroll-child key={index}>
                ...
                <div className={styles.cardVehicleBody}>
                  <div className={styles.cardVehicleHeader}>
                    <h5 className={styles.cardName}>{vehicle.name}</h5>
                  ...
                  <div className={styles.cardBtnContainer}>
                    <button
                      ...
                      onClick={() =>
                        window.open(
                          `https://wa.me/6285645733351?text=Halo%20TS%20Group%2C%20saya%20tertarik%20dengan%20sewa%20mobil%20${encodeURIComponent(vehicle.name)}`,
                          "_blank"
                        )
                      }
                    >
