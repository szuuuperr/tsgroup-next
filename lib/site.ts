export const SITE = {
  name: "TS Group Tour & Travel",
  shortName: "TS Group",
  description:
    "TS Group Tour & Travel - Layanan rental mobil dan paket wisata terbaik di Yogyakarta. Armada nyaman, harga terjangkau, sopir berpengalaman.",
  phone: "085645733351",
  phoneDisplay: "0856-4573-3351",
  whatsappNumber: "6285645733351",
  email: "info@tsgrouptour.com",
  address:
    "Pangukan, Panglikan, Tridadi, Kec. Sleman, Kabupaten Sleman, Daerah Istimewa Yogyakarta 55511",
  googleReviewUrl:
    "https://www.google.com/search?client=firefox-b-d&hs=KeCV&si=AL3DRZEsmMGCryMMFSHJ3StBhOdZ2-6yYkXd_doETEE1OR-qOVYOXmp-r9QP1AyO_Xe1u3dDtIjBR4hCEDmwsTm6kZPL8L9S7-1n2GIZMVgpzGINkti0pl24_ZDSMcS6ZbBz53ceAU-b94gmLcd7r59OK4OcVRoCuw%3D%3D&q=TS+GROUP+TOUR+N+TRAVEL+Ulasan&sa=X#lrd=0x2e7a59775406a531:0xe5e692e3e23ede8f,3,,,,",
};

export const WHATSAPP_URL = `https://wa.me/${SITE.whatsappNumber}`;

/** Sosial media resmi; ikon berupa path data SVG (viewBox 0 0 24 24). */
...
/** Path data SVG logo WhatsApp (viewBox 0 0 640 640). */
export const WHATSAPP_ICON_640 =
...
/** Link WhatsApp dengan pesan terisi otomatis. */
